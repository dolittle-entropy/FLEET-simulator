...
create (ms3v1)<-[:AtefactVersion]-(d5:Deployment {number:5, created:date('2021-02-05'), retired:date('2021-08-05')})-[:RuntimeVersion]->(drv2)
create (mongo44)<-[:AtefactVersion]-(d5)
create (ms3v2)<-[:AtefactVersion]-(d6:Deployment {number:6, created:date('2021-08-05')})-[:RuntimeVersion]->(drv4)
create (mongo44)<-[:ArtefactVersion]-(d6)
create (ms1v3)<-[:AtefactVersion]-(sd1:StagingDeployment {number:1, created:date('2021-08-08'), retired:date('2021-08-10')})-[:RuntimeVersion]->(drv5)
